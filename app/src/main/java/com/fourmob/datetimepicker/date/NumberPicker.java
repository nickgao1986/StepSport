...
public class NumberPicker extends LinearLayout {
    ...
    /**
     * The responsible for flinging the selector.
     */
    private final Scroller mFlingScroller;

    /**
     * The responsible for adjusting the selector.
     */
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(
                attrs, R.styleable.NumberPicker, defStyle, R.style.NPWidget_Holo_Light_NumberPicker);
...
//        mInputText.setRawInputType(InputType.TYPE_CLASS_NUMBER);
    ...
    public void setDisplayedValues(String[] displayedValues) {
        ...
        /** 魅蓝手机 bug start  调用下面该方法会自动弹出软键盘 **/
//        if (mDisplayedValues != null) {
...
//        }
    ...
    private boolean updateInputTextView() {
         ...
         * number.
         */
        String text = (mDisplayedValues == null || mDisplayedValues.length == 0 ) ? formatNumber(mValue)
    ...
    /**
     * Posts an from the given <code>selectionStart
