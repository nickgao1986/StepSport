...
public class PicWallScrollView extends ScrollView implements OnTouchListener {
    /**
     * 每页要加载的图片数量
     */
    ...
    private final static String TAG = PicWallScrollView.class.getSimpleName();
    ...
    private static Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            PicWallScrollView myScrollView = (PicWallScrollView) msg.obj;
    ...
    class LoadImageTask extends AsyncTask<String, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap bitmap) {
            if (bitmap != null) {
                //核心代码，新建一个imageView, imageView宽度是相同的(屏幕的1/3)，可是高度必须根据bitmap原有宽度等比例计算出高度，
                // 这样图片才不会失真，然后把imageView添加到屏幕上展示
